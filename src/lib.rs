...
mod tests {
    ...
    fn time_1() {
        ...
        let stamp = crate::systime_to_raw(now);
        let now2 = crate::raw_to_systime(stamp);
    ...
    fn bhdrsize_1() {
        ...
        assert_eq!(crate::body_header_size(), item.payload.len());
    }
    #[test]
    fn strlen_1() {
        ...
        bvec.push(0);
        assert_eq!(test_string.len(), crate::string_len(&bvec));
    }
    #[test]
    fn getcstr_1() {
        let test_string = String::from("Hello world");
        ...
        assert_eq!(
            test_string,
            crate::get_c_string(&mut offset, &bvec)
        );
